...
namespace Atlas.Core
{
    ...
    public class Triangulator
    {
        ...
        private float Area()
        {
            ...
            {
                var pval = borderPoints[p];
                var qval = borderPoints[q];
        ...
        {
            int p;
            var A = borderPoints[V[u]];
            var B = borderPoints[V[v]];
            var C = borderPoints[V[w]];
